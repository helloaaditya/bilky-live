              ...
              <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                ...
                <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4 mb-8 md:mb-12">
                  ...
                  <div className="grid sm:grid-cols-2 gap-6 mb-2 md:mb-4">
                    ...
                    <div className="relative group w-full transition-all duration-300 transform hover:scale-105 flex justify-center">
                      <img src="https://media.chingari.io/apipublic/chingari-web-assets/icons/browser.svg" alt="Download APK" className="h-14 w-auto" />
                    </div>
                  </div>
            ...
            <div className="w-full md:w-1/2 relative mr-10 z-10 mt-8 md:mt-0">
              <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                <div className="relative mx-auto max-w-sm md:max-w-none">
                  ...
                  <div className="hidden sm:block absolute -left-4 md:-left-10 top-1/1 bg-white p-3 md:p-4 rounded-xl shadow-lg">
                  ...
                  <div className="hidden sm:block absolute -left-4 md:-left-16 bottom-1/2 bg-white p-3 md:p-4 rounded-xl shadow-lg">
